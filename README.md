...
# Our work
&emsp;&emsp;I share with you the effect of improved version <b>SimSwapHD</b>, which has made changes in architecture and faceswap-processing. SimSwapHD supports face-swapping on high-definition videos and only relies on an arbitrary picture as input.<br />
&emsp;&emsp;<b>SimSwapHD</b> is made from our group: <b>Bytedance AI-Lab SA_TTS</b> and is not open-source yet.<br />
