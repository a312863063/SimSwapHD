...
class fsModel(BaseModel):
    ...
    def initialize(self, opt):
        ...
        if self.isTrain:
            ...
            self.loss_names = self.loss_filter('G_GAN', 'G_GAN_Feat', 'G_VGG', 'G_ID', 'G_Rec', 
                                               'D_GP', 'D_real', 'D_fake')
    ...
    def forward(self, img_id, img_att, latent_id, latent_att, for_G = False):
        ...
        # D_GP
        #loss_D_GP = 0
        loss_D_GP = (self._gradinet_penalty_D(self.netD1, img_att, img_fake) + \
                    self._gradinet_penalty_D(self.netD2, img_att_downsample, img_fake_downsample)) * self.opt.lambda_GP
