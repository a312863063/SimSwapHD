...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='CelebA_512_finetune', help='name of the experiment. It decides where to store samples and models')
        ...
        # for displays and image_size
        self.parser.add_argument('--display_winsize', type=int, default=512, help='display window size')
        self.parser.add_argument('--image_size', type=int, default=512, help='training image resize')
